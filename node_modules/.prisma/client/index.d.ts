...
/**
  ...
  /**
   * `prisma.contactusResponse`: Exposes CRUD operations for the **ContactusResponse** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more ContactusResponses
    * const contactusResponses = await prisma.contactusResponse.findMany()
    * ```
    */
  get contactusResponse(): Prisma.ContactusResponseDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type AggregateContactusResponse = {
    _count: ContactusResponseCountAggregateOutputType | null
    _min: ContactusResponseMinAggregateOutputType | null
    _max: ContactusResponseMaxAggregateOutputType | null
  }

  export type ContactusResponseMinAggregateOutputType = {
    id: string | null
    name: string | null
    email: string | null
    company: string | null
  ...
  export type ContactusResponseMaxAggregateOutputType = {
    id: string | null
    name: string | null
    email: string | null
    company: string | null
  ...
  export type ContactusResponseCountAggregateOutputType = {
    id: number
    name: number
    email: number
    company: number
  ...
  export type ContactusResponseMinAggregateInputType = {
    id?: true
    name?: true
    email?: true
    company?: true
  ...
  export type ContactusResponseMaxAggregateInputType = {
    id?: true
    name?: true
    email?: true
    company?: true
  ...
  export type ContactusResponseCountAggregateInputType = {
    id?: true
    name?: true
    email?: true
    company?: true
  ...
  export type ContactusResponseAggregateArgs = {
    /**
     * Filter which ContactusResponse to aggregate.
     */
    where?: ContactusResponseWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     * 
     * Determine the order of ContactusResponses to fetch.
     */
    orderBy?: Enumerable<ContactusResponseOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
     */
    cursor?: ContactusResponseWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Take `±n` ContactusResponses from the position of the cursor.
     */
    take?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Skip the first `n` ContactusResponses.
     */
    skip?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Count returned ContactusResponses
    **/
    _count?: true | ContactusResponseCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    _min?: ContactusResponseMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    _max?: ContactusResponseMaxAggregateInputType
  }

  export type GetContactusResponseAggregateType<T extends ContactusResponseAggregateArgs> = {
        [P in keyof T & keyof AggregateContactusResponse]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
        : GetScalarType<T[P], AggregateContactusResponse[P]>
      : GetScalarType<T[P], AggregateContactusResponse[P]>
  }
  ...
  export type ContactusResponseGroupByArgs = {
    where?: ContactusResponseWhereInput
    orderBy?: Enumerable<ContactusResponseOrderByWithAggregationInput>
    by: ContactusResponseScalarFieldEnum[]
    having?: ContactusResponseScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    _count?: ContactusResponseCountAggregateInputType | true
    _min?: ContactusResponseMinAggregateInputType
    _max?: ContactusResponseMaxAggregateInputType
  }


  export type ContactusResponseGroupByOutputType = {
    id: string
    name: string
    email: string
    company: string | null
  ...
  type GetContactusResponseGroupByPayload<T extends ContactusResponseGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<ContactusResponseGroupByOutputType, T['by']> &
        {
          [P in ((keyof T) & (keyof ContactusResponseGroupByOutputType))]: P extends '_count'
            ? T[P] extends boolean
              ? number
              : GetScalarType<T[P], ContactusResponseGroupByOutputType[P]>
            : GetScalarType<T[P], ContactusResponseGroupByOutputType[P]>
        }
      >
    >
  ...
  export type ContactusResponseSelect = {
    id?: boolean
    name?: boolean
    email?: boolean
    company?: boolean
  ...
  export type ContactusResponseGetPayload<S extends boolean | null | undefined | ContactusResponseArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? ContactusResponse :
    S extends undefined ? never :
    S extends { include: any } & (ContactusResponseArgs | ContactusResponseFindManyArgs)
    ? ContactusResponse 
    : S extends { select: any } & (ContactusResponseArgs | ContactusResponseFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof ContactusResponse ? ContactusResponse[P] : never
  } 
      : ContactusResponse


  type ContactusResponseCountArgs = 
    Omit<ContactusResponseFindManyArgs, 'select' | 'include'> & {
      select?: ContactusResponseCountAggregateInputType | true
    }

  export interface ContactusResponseDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {

    /**
     * Find zero or one ContactusResponse that matches the filter.
     * @param {ContactusResponseFindUniqueArgs} args - Arguments to find a ContactusResponse
     * @example
     * // Get one ContactusResponse
     * const contactusResponse = await prisma.contactusResponse.findUnique({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUnique<T extends ContactusResponseFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, ContactusResponseFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'ContactusResponse'> extends True ? Prisma__ContactusResponseClient<ContactusResponseGetPayload<T>> : Prisma__ContactusResponseClient<ContactusResponseGetPayload<T> | null, null>

    /**
     * Find one ContactusResponse that matches the filter or throw an error  with `error.code='P2025'` 
     *     if no matches were found.
     * @param {ContactusResponseFindUniqueOrThrowArgs} args - Arguments to find a ContactusResponse
     * @example
     * // Get one ContactusResponse
     * const contactusResponse = await prisma.contactusResponse.findUniqueOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUniqueOrThrow<T extends ContactusResponseFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, ContactusResponseFindUniqueOrThrowArgs>
    ): Prisma__ContactusResponseClient<ContactusResponseGetPayload<T>>

    /**
     * Find the first ContactusResponse that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {ContactusResponseFindFirstArgs} args - Arguments to find a ContactusResponse
     * @example
     * // Get one ContactusResponse
     * const contactusResponse = await prisma.contactusResponse.findFirst({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirst<T extends ContactusResponseFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, ContactusResponseFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'ContactusResponse'> extends True ? Prisma__ContactusResponseClient<ContactusResponseGetPayload<T>> : Prisma__ContactusResponseClient<ContactusResponseGetPayload<T> | null, null>

    /**
     * Find the first ContactusResponse that matches the filter or
     * throw `NotFoundError` if no matches were found.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {ContactusResponseFindFirstOrThrowArgs} args - Arguments to find a ContactusResponse
     * @example
     * // Get one ContactusResponse
     * const contactusResponse = await prisma.contactusResponse.findFirstOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirstOrThrow<T extends ContactusResponseFindFirstOrThrowArgs>(
      args?: SelectSubset<T, ContactusResponseFindFirstOrThrowArgs>
    ): Prisma__ContactusResponseClient<ContactusResponseGetPayload<T>>

    /**
     * Find zero or more ContactusResponses that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {ContactusResponseFindManyArgs=} args - Arguments to filter and select certain fields only.
     * @example
     * // Get all ContactusResponses
     * const contactusResponses = await prisma.contactusResponse.findMany()
     * 
     * // Get first 10 ContactusResponses
     * const contactusResponses = await prisma.contactusResponse.findMany({ take: 10 })
     * 
     * // Only select the `id`
     * const contactusResponseWithIdOnly = await prisma.contactusResponse.findMany({ select: { id: true } })
     * 
    **/
    findMany<T extends ContactusResponseFindManyArgs>(
      args?: SelectSubset<T, ContactusResponseFindManyArgs>
    ): Prisma.PrismaPromise<Array<ContactusResponseGetPayload<T>>>

    /**
     * Create a ContactusResponse.
     * @param {ContactusResponseCreateArgs} args - Arguments to create a ContactusResponse.
     * @example
     * // Create one ContactusResponse
     * const ContactusResponse = await prisma.contactusResponse.create({
     *   data: {
     *     // ... data to create a ContactusResponse
     *   }
     * })
     * 
    **/
    create<T extends ContactusResponseCreateArgs>(
      args: SelectSubset<T, ContactusResponseCreateArgs>
    ): Prisma__ContactusResponseClient<ContactusResponseGetPayload<T>>

    /**
     * Create many ContactusResponses.
     *     @param {ContactusResponseCreateManyArgs} args - Arguments to create many ContactusResponses.
     *     @example
     *     // Create many ContactusResponses
     *     const contactusResponse = await prisma.contactusResponse.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends ContactusResponseCreateManyArgs>(
      args?: SelectSubset<T, ContactusResponseCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Delete a ContactusResponse.
     * @param {ContactusResponseDeleteArgs} args - Arguments to delete one ContactusResponse.
     * @example
     * // Delete one ContactusResponse
     * const ContactusResponse = await prisma.contactusResponse.delete({
     *   where: {
     *     // ... filter to delete one ContactusResponse
     *   }
     * })
     * 
    **/
    delete<T extends ContactusResponseDeleteArgs>(
      args: SelectSubset<T, ContactusResponseDeleteArgs>
    ): Prisma__ContactusResponseClient<ContactusResponseGetPayload<T>>

    /**
     * Update one ContactusResponse.
     * @param {ContactusResponseUpdateArgs} args - Arguments to update one ContactusResponse.
     * @example
     * // Update one ContactusResponse
     * const contactusResponse = await prisma.contactusResponse.update({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    update<T extends ContactusResponseUpdateArgs>(
      args: SelectSubset<T, ContactusResponseUpdateArgs>
    ): Prisma__ContactusResponseClient<ContactusResponseGetPayload<T>>

    /**
     * Delete zero or more ContactusResponses.
     * @param {ContactusResponseDeleteManyArgs} args - Arguments to filter ContactusResponses to delete.
     * @example
     * // Delete a few ContactusResponses
     * const { count } = await prisma.contactusResponse.deleteMany({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     * 
    **/
    deleteMany<T extends ContactusResponseDeleteManyArgs>(
      args?: SelectSubset<T, ContactusResponseDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Update zero or more ContactusResponses.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {ContactusResponseUpdateManyArgs} args - Arguments to update one or more rows.
     * @example
     * // Update many ContactusResponses
     * const contactusResponse = await prisma.contactusResponse.updateMany({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    updateMany<T extends ContactusResponseUpdateManyArgs>(
      args: SelectSubset<T, ContactusResponseUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Create or update one ContactusResponse.
     * @param {ContactusResponseUpsertArgs} args - Arguments to update or create a ContactusResponse.
     * @example
     * // Update or create a ContactusResponse
     * const contactusResponse = await prisma.contactusResponse.upsert({
     *   create: {
     *     // ... data to create a ContactusResponse
     *   },
     *   update: {
     ...
     *   },
     *   where: {
     *     // ... the filter for the ContactusResponse we want to update
     *   }
     * })
    **/
    upsert<T extends ContactusResponseUpsertArgs>(
      args: SelectSubset<T, ContactusResponseUpsertArgs>
    ): Prisma__ContactusResponseClient<ContactusResponseGetPayload<T>>

    /**
     * Count the number of ContactusResponses.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {ContactusResponseCountArgs} args - Arguments to filter ContactusResponses to count.
     * @example
     * // Count the number of ContactusResponses
     * const count = await prisma.contactusResponse.count({
     *   where: {
     *     // ... the filter for the ContactusResponses we want to count
     *   }
     * })
    **/
    count<T extends ContactusResponseCountArgs>(
      args?: Subset<T, ContactusResponseCountArgs>,
    ): Prisma.PrismaPromise<
      T extends _Record<'select', any>
        ? T['select'] extends true
          ? number
          : GetScalarType<T['select'], ContactusResponseCountAggregateOutputType>
        : number
    >

    /**
     * Allows you to perform aggregations operations on a ContactusResponse.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {ContactusResponseAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
     * // Ordered by age ascending
     * // Where email contains prisma.io
     * // Limited to the 10 users
     ...
     * })
    **/
    aggregate<T extends ContactusResponseAggregateArgs>(args: Subset<T, ContactusResponseAggregateArgs>): Prisma.PrismaPromise<GetContactusResponseAggregateType<T>>

    /**
     * Group by ContactusResponse.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {ContactusResponseGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends ContactusResponseGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: ContactusResponseGroupByArgs['orderBy'] }
        : { orderBy?: ContactusResponseGroupByArgs['orderBy'] },
      OrderFields extends ExcludeUnderscoreKeys<Keys<MaybeTupleToUnion<T['orderBy']>>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, ContactusResponseGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetContactusResponseGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>

  }

  /**
   * The delegate class that acts as a "Promise-like" for ContactusResponse.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__ContactusResponseClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
  ...
  /**
   * ContactusResponse base type for findUnique actions
   */
  export type ContactusResponseFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the ContactusResponse
     */
    select?: ContactusResponseSelect | null
    /**
     * Filter, which ContactusResponse to fetch.
     */
    where: ContactusResponseWhereUniqueInput
  }

  /**
   * ContactusResponse findUnique
   */
  export interface ContactusResponseFindUniqueArgs extends ContactusResponseFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * ContactusResponse findUniqueOrThrow
   */
  export type ContactusResponseFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the ContactusResponse
     */
    select?: ContactusResponseSelect | null
  ...
  /**
   * ContactusResponse base type for findFirst actions
   */
  export type ContactusResponseFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the ContactusResponse
     */
    select?: ContactusResponseSelect | null
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for searching for ContactusResponses.
     */
    cursor?: ContactusResponseWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/distinct Distinct Docs}
     * 
     * Filter by unique combinations of ContactusResponses.
     */
    distinct?: Enumerable<ContactusResponseScalarFieldEnum>
  }

  /**
   * ContactusResponse findFirst
   */
  export interface ContactusResponseFindFirstArgs extends ContactusResponseFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  /**
   * ContactusResponse findFirstOrThrow
   */
  export type ContactusResponseFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the ContactusResponse
     */
    select?: ContactusResponseSelect | null
  ...
  /**
   * ContactusResponse findMany
   */
  export type ContactusResponseFindManyArgs = {
    /**
     * Select specific fields to fetch from the ContactusResponse
     */
    select?: ContactusResponseSelect | null
    /**
     * Filter, which ContactusResponses to fetch.
     */
    where?: ContactusResponseWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for listing ContactusResponses.
     */
    cursor?: ContactusResponseWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
  ...
  /**
   * ContactusResponse create
   */
  export type ContactusResponseCreateArgs = {
    /**
     * Select specific fields to fetch from the ContactusResponse
     */
    select?: ContactusResponseSelect | null
    /**
     * The data needed to create a ContactusResponse.
     */
    data: XOR<ContactusResponseCreateInput, ContactusResponseUncheckedCreateInput>
  }


  /**
   * ContactusResponse createMany
   */
  export type ContactusResponseCreateManyArgs = {
    /**
     * The data used to create many ContactusResponses.
     */
    data: Enumerable<ContactusResponseCreateManyInput>
    skipDuplicates?: boolean
  }


  /**
   * ContactusResponse update
   */
  export type ContactusResponseUpdateArgs = {
    /**
     * Select specific fields to fetch from the ContactusResponse
     */
    select?: ContactusResponseSelect | null
    /**
     * The data needed to update a ContactusResponse.
     */
    data: XOR<ContactusResponseUpdateInput, ContactusResponseUncheckedUpdateInput>
    /**
     * Choose, which ContactusResponse to update.
     */
    where: ContactusResponseWhereUniqueInput
  }
  ...
  /**
   * ContactusResponse updateMany
   */
  export type ContactusResponseUpdateManyArgs = {
    /**
     * The data used to update ContactusResponses.
     */
    data: XOR<ContactusResponseUpdateManyMutationInput, ContactusResponseUncheckedUpdateManyInput>
    /**
     * Filter which ContactusResponses to update
     */
    where?: ContactusResponseWhereInput
  }
  ...
  /**
   * ContactusResponse upsert
   */
  export type ContactusResponseUpsertArgs = {
    /**
     * Select specific fields to fetch from the ContactusResponse
     */
    select?: ContactusResponseSelect | null
    /**
     * The filter to search for the ContactusResponse to update in case it exists.
     */
    where: ContactusResponseWhereUniqueInput
    /**
     * In case the ContactusResponse found by the `where` argument doesn't exist, create a new ContactusResponse with this data.
     */
    create: XOR<ContactusResponseCreateInput, ContactusResponseUncheckedCreateInput>
    /**
     * In case the ContactusResponse was found with the provided `where` argument, update it with this data.
     */
    update: XOR<ContactusResponseUpdateInput, ContactusResponseUncheckedUpdateInput>
  }


  /**
   * ContactusResponse delete
   */
  export type ContactusResponseDeleteArgs = {
    /**
     * Select specific fields to fetch from the ContactusResponse
     */
    select?: ContactusResponseSelect | null
    /**
     * Filter which ContactusResponse to delete.
     */
    where: ContactusResponseWhereUniqueInput
  }
  ...
  /**
   * ContactusResponse deleteMany
   */
  export type ContactusResponseDeleteManyArgs = {
    /**
     * Filter which ContactusResponses to delete
     */
    where?: ContactusResponseWhereInput
  }
  ...
  /**
   * ContactusResponse without action
   */
  export type ContactusResponseArgs = {
    /**
     * Select specific fields to fetch from the ContactusResponse
     */
    select?: ContactusResponseSelect | null
  ...
  export const ContactusResponseScalarFieldEnum: {
    id: 'id',
    name: 'name',
    email: 'email',
    company: 'company',
  ...
  export type ContactusResponseScalarFieldEnum = (typeof ContactusResponseScalarFieldEnum)[keyof typeof ContactusResponseScalarFieldEnum]
  ...
  export type ApplicationForDistributionSystemWhereInput = {
    ...
    extraInfo?: StringNullableFilter | string | null
  }
  ...
  export type ApplicationForDistributionSystemScalarWhereWithAggregatesInput = {
    ...
    extraInfo?: StringNullableWithAggregatesFilter | string | null
  }
  ...
  export type ContactusResponseWhereInput = {
    AND?: Enumerable<ContactusResponseWhereInput>
    OR?: Enumerable<ContactusResponseWhereInput>
    NOT?: Enumerable<ContactusResponseWhereInput>
    id?: StringFilter | string
    name?: StringFilter | string
    email?: StringFilter | string
  ...
  export type ContactusResponseOrderByWithRelationInput = {
    id?: SortOrder
    name?: SortOrder
    email?: SortOrder
    company?: SortOrder
  ...
  export type ContactusResponseWhereUniqueInput = {
    id?: string
  }

  export type ContactusResponseOrderByWithAggregationInput = {
    id?: SortOrder
    name?: SortOrder
    email?: SortOrder
    company?: SortOrder
    Subject?: SortOrder
    message?: SortOrder
    _count?: ContactusResponseCountOrderByAggregateInput
    _max?: ContactusResponseMaxOrderByAggregateInput
    _min?: ContactusResponseMinOrderByAggregateInput
  }

  export type ContactusResponseScalarWhereWithAggregatesInput = {
    AND?: Enumerable<ContactusResponseScalarWhereWithAggregatesInput>
    OR?: Enumerable<ContactusResponseScalarWhereWithAggregatesInput>
    NOT?: Enumerable<ContactusResponseScalarWhereWithAggregatesInput>
    id?: StringWithAggregatesFilter | string
    name?: StringWithAggregatesFilter | string
    email?: StringWithAggregatesFilter | string
  ...
  export type ContactusResponseCreateInput = {
    id?: string
    name: string
    email: string
    company?: string | null
  ...
  export type ContactusResponseUncheckedCreateInput = {
    id?: string
    name: string
    email: string
    company?: string | null
  ...
  export type ContactusResponseUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
  ...
  export type ContactusResponseUncheckedUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    company?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ContactusResponseCreateManyInput = {
    id?: string
    name: string
    email: string
    company?: string | null
  ...
  export type ContactusResponseUpdateManyMutationInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    company?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ContactusResponseUncheckedUpdateManyInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    company?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ContactusResponseCountOrderByAggregateInput = {
    id?: SortOrder
    name?: SortOrder
    email?: SortOrder
    company?: SortOrder
  ...
  export type ContactusResponseMaxOrderByAggregateInput = {
    id?: SortOrder
    name?: SortOrder
    email?: SortOrder
    company?: SortOrder
  ...
  export type ContactusResponseMinOrderByAggregateInput = {
    id?: SortOrder
    name?: SortOrder
    email?: SortOrder
    company?: SortOrder
